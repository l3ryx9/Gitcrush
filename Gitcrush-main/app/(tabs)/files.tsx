...
export default function FilesScreen() {
  ...
  const { user, repos, selectedRepo, branches, currentBranch, selectRepo, selectBranch, pushFile, deleteDirectory, deleteBranch, deleteRepo, reposLoading, loading } = useGitHub();
